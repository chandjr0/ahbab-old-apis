...
router
  ...
  .get(
    [
      ...
      checkPagination,
      verifyToken,
      permission("customer", "admin", "employee"),
    ],
    orderController.fetchAllCustomerOrder
  );

router
  .route("/customers/previous-orders/:customerId/:orderId")
  .get(
    [
      celebrate(orderValidation.fetchAllCustomerPendingOrder),
      checkPagination,
      verifyToken,
      permission("admin", "employee"),
    ],
    orderController.fetchAllCustomerPendingOrder
  );
