...
const productController = require("../../controllers/product/adminCustomerController");
...
router
  .route("/new-arrival-products") // ?page=1&limit=1
  .get([celebrate(productValidation.pagination)], productController.fetchAllNewArrivalProducts);
